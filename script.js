...
document.getElementById('btn_agregar').addEventListener('click', () => {
    ...
    if(si_falla){
        ...
        if(contador === 4){//contador igual al nro de intentos
            document.getElementById('btn_agregar').disabled = true;//desabilito boton
            document.getElementById('id_texto').disabled = true;//desabilito input
            ...
            document.getElementById('btn_agregar').disabled = true;//desabilito boton
            document.getElementById('id_texto').disabled = true;//desabilito inpu
